 ...
 */
export class CUSDEventListeners {
  private static contractsEventListenerKit: CUSDEventListeners;

  /**
   * Creates a new instance of contract kit event listeners.
   */
  static createInstance(cUSDAddress: string) {
    if (this.contractsEventListenerKit) {
      console.log('Event listener running!!');
    } else {
      this.contractsEventListenerKit = new CUSDEventListeners(cUSDAddress);
    }
  }
   ...
   * Class constructor.
   */
  private constructor(cUSDAddress: string) {
    this.setupProviderAndSubscriptions(cUSDAddress);
   ...
   */
  setupProviderAndSubscriptions(cUSDAddress: string) {
