 ...
 */
export class CEUROventListeners {
  private static contractsEventListenerKit: CEUROventListeners;

  /**
   * Creates a new instance of contract kit event listeners.
   */
  static createInstance(cEUROAddress: string) {
    if (this.contractsEventListenerKit) {
      console.log('Event listener running!!');
    } else {
      this.contractsEventListenerKit = new CEUROventListeners(cEUROAddress);
    }
  }
   ...
   * Class constructor.
   */
  private constructor(cEUROAddress: string) {
    this.setupProviderAndSubscriptions(cEUROAddress);
   ...
   */
  setupProviderAndSubscriptions(cEUROAddress: string) {
